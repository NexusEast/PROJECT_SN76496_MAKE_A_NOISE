...
void DrawPage(PageContainer_t *container)
{
		...
		if(container->pageIndex == 0) {
			WriteDisplayNoClear(container->header , DISPLAY_BLUE_COLOR , 0 , 5);
			WriteDisplayNoClear(container->line_one , DISPLAY_BLUE_COLOR , 0 , 20);
			WriteDisplayNoClear(container->line_two , DISPLAY_BLUE_COLOR , 0 , 35);
			WriteDisplayNoClear(container->line_three , DISPLAY_BLUE_COLOR , 0 , 50);
		}
		else {
			WriteDisplayNoClear(container->header , DISPLAY_BLUE_COLOR , 0 , 5);
			WriteDisplayNoClear(container->line_one , DISPLAY_BLUE_COLOR , 0 , 20);
